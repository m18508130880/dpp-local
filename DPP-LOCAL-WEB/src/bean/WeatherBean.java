...
//		outprint.write(Resp);
	...
	public String getSql(int pCmd)
	{
		...
		{
			case 0:// 查询每天历史最大天气数据
				Sql = " select t.ctime, t.prs, t.tem, t.rhu, max(t.pre_1h) as pre_1h, t.wep_now " + 
					  " from weather t " + 
					  " where t.Station_Id_C = '" + Station_Id_C + "'"+
				  	  " GROUP BY SUBSTR(ctime,1,10) ORDER BY ctime DESC ";
				break;			
			case 1:// 查询每天历史最大天气数据
				Sql = " select t.ctime, t.prs, t.tem, t.rhu, pre_1h, WEP_Now " + 
					  " FROM weather " +
				...
				break;
			case 2:// 查询历史
				Sql = " select t.ctime, t.prs, t.tem, t.rhu, t.pre_1h, t.wep_now " + 
					  " from weather t " + 
					  " where t.Station_Id_C = '" + Station_Id_C + "'"+
	...
	public boolean getData(ResultSet pRs)
	{
		...
		try
		{
			...
			setPRS(pRs.getString(2));
			setTEM(pRs.getString(3));
			setRHU(pRs.getString(4));
			setPRE_1h(pRs.getString(5));
			setWEP_Now(pRs.getString(6));
		}
