...
{	
	...
	public void ExecCmd(HttpServletRequest request, HttpServletResponse response, Rmi pRmi, boolean pFromZone) throws ServletException, IOException
	{
		...
		switch(currStatus.getCmd())
		{
		    ...
		    case 0://查询
				...
				{
					request.getSession().setAttribute("Corp_Info_" + Sid, (ThreeGJBean)((ArrayList<?>)msgBean.getMsg()).get(0));
				}
		    ...
		    case 1://查询
		    	if(null != msgBean.getMsg() && ((ArrayList<?>)msgBean.getMsg()).size() > 0)
				{
					request.getSession().setAttribute("User_Announce_" + Sid, (ThreeGJBean)((ArrayList<?>)msgBean.getMsg()).get(0));
				}
	...
	public void ConThree(HttpServletRequest request, HttpServletResponse response, Rmi pRmi, boolean pFromZone) throws ServletException, IOException
	{
		getHtmlData(request);
		currStatus = (CurrStatus)request.getSession().getAttribute("CurrStatus_" + Sid);
		currStatus.getHtmlData(request, pFromZone);
		...
		String Resp = "9999";
		//DevGJBean devGJBean = new DevGJBean(currStatus);
		//msgBean = pRmi.RmiExec(2, devGJBean, 0, 25);
